    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white p-6 md:p-12">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <a
            href="/admin/events"
            className="group flex items-center gap-4 bg-[#111] hover:bg-[#1a1a1a] border border-[#333] text-white px-6 py-4 rounded-lg font-semibold text-lg transition-all active:scale-[0.98]"
          >
            <Activity className="w-6 h-6 text-[#9AE600] shrink-0" />
            <div>
              <span className="block">Events</span>
              <span className="block text-sm font-normal text-gray-400">Manage slots and entries</span>
            </div>
            <ArrowRight className="w-5 h-5 ml-auto text-gray-500 group-hover:translate-x-1 transition-transform" />
          </a>
